const Footer = () => {
  ...
  return (
    ...
    <footer className="">
      ...
      <span className="text-lg text-white dark:text-gray-400 text-3xl md:text-4xl lg:text-5xl">@2023 Pato a Jato. Todos os direitos reservados</span>
      <span className="text-lg text-white dark:text-gray-400 text-3xl md:text-4xl lg:text-5xl">Desenvolvido por Analice Moschen</span>
